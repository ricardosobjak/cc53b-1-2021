...
<form action="anuncio/anuncio.controller.php" method="POST" name="form1" id="form1">
	...
	<input type="text" name="destaque" class="form-control" value="<?php echo $fDestaque; ?>" />

	<label for="">Preço</label>
	<input type="number" name="preco" class="form-control" value="<?php echo $fPreco; ?>" />

	<label for="">Descrição</label>
	<textarea name="descricao" class="form-control"><?php echo $fDescricao; ?></textarea>
